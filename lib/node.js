...
var WS_SECRET = process.env.WS_SECRET || "Hello";
...
Node.prototype.startWeb3Connection = function()
{
	...
	web3 = new Web3();
	var url = 'http://' + (process.env.RPC_HOST || 'localhost') + ':' + (process.env.RPC_PORT || '8545');
	//url = "http://3.216.212.77:22001";
	console.info('rpc url: ', url);
